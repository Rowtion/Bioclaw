...
|------|------|---------|----------|-------------|
| ra | float | None | No | Right ascension coordinate in degrees |
| dec | float | None | No | Declination coordinate in degrees |
| frame | string | "icrs" | No | Coordinate frame (icrs, galactic, fk5, altaz) |
| unit | Unit | None | No | Astropy unit for quantities (e.g., u.degree, u.pc) |
| time | string | None | No | Time string in ISO format (e.g., '2023-01-15 12:30:00') |
| time_scale | string | "utc" | No | Time scale (utc, tai, tt, tdb) |
| filename | string | "" | Yes | Path to FITS file or table |
| z | float | None | No | Redshift for cosmological calculations |
| cosmology | string | "Planck18" | No | Cosmological model (Planck18, WMAP9) |
| format | string | None | No | File format (fits, csv, hdf5) |
