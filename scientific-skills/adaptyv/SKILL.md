...
|------|------|---------|----------|-------------|
| sequences | string | "" | Yes | Protein sequences in FASTA format to test |
| experiment_type | string | "binding" | Yes | Type of experiment (binding, expression, thermostability, enzyme_activity) |
| webhook_url | string | "" | No | URL to receive experiment status callbacks |
| api_key | string | env var | Yes | Adaptyv API key for authentication |
| base_url | string | "https://kq5jp7qj7wdqklhsxmovkzn4l40obksv.lambda-url.eu-central-1.on.aws" | No | Adaptyv API base URL |
