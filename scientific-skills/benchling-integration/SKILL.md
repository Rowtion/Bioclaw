...
|------|------|---------|----------|-------------|
| url | string | "" | Yes | Benchling tenant URL (e.g., https://your-tenant.benchling.com) |
| api_key | string | "" | Yes | API key for authentication |
| entity_id | string | "" | Yes | Unique identifier for registry entity |
| sequence | string | "" | Yes | DNA/RNA/protein sequence |
| name | string | "" | Yes | Entity or container name |
| folder_id | string | "" | No | Folder ID for organization |
| schema_id | string | "" | No | Schema ID for custom fields |
| is_circular | boolean | false | No | Whether DNA sequence is circular |
| fields | dict | None | No | Custom schema fields dictionary |
| container_id | string | "" | No | Container identifier for inventory |
| workflow_id | string | "" | No | Workflow identifier for automation |
| task_id | string | "" | No | Workflow task identifier |
